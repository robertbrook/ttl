...
app.get('/render', function (req, res) {
    ...
    const urlstub = req.query.url;
    const ttlurl = `https://raw.githubusercontent.com/ukparliament/ontologies/master/${urlstub}/${urlstub}-ontology.ttl`;
    ...
    request(ttlurl, function (error, response, body) {
        ...
        subjects.forEach(function (subject) {
            ...
            store.forEach(
                function (thisQuad) {
                    subjectPack.push(thisQuad);
                }, subject.id, null, null, null
            );
